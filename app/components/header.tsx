    ...
    return (
        <header className={isOpen ? 'absolute flex flex-col items-center transition-height duration-1000 ease-in-out h-full bg-[#161616]': 'relative'} style={headerStyle}>
            <div 
                className={
                    isOpen ? 
                        'flex justify-between items-center w-[390px] h-fit mt-[30px] gap-6' : 
                        'flex justify-between items-center px-10 py-[30px] border border-[#161616]'}>
                ...
                <div className='connect-btn'>
                    <p className='text-[#fbfbfb] px-6 py-[12px] bg-[#3b3b3b3e] border-2 border-[#b89ba12e] rounded-[64px] cursor-pointer'>Connect</p>
                </div>
            ...
            <div className='relative w-[390px] mt-6'>
                {
                    isOpen ?
